...
class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('tadmin/assets/') }}" data-template="vertical-menu-template-free">
...
<head>
    ...
    <title>Login | Nebula Enviro</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('tadmin/assets/vendor/css/core.css') }}"
...
<body>
    ...
    <div class="container-xxl" style="max-width: 800px; margin-top: 100px">
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Nebula Enviro</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome Admin! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start customize the page</p>
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('adminLogin') }}">
                            @csrf
                
                            <!-- Email Address -->
                            <div class="mb-3">
                                <x-label for="email" class="form-label" :value="__('Email or Username')" />
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <x-button class="ml-3 btn btn-primary d-grid w-100">
                                    {{ __('Log in') }}
                                </x-button>
                            </div>
                        </form>
