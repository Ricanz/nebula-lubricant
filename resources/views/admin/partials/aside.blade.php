<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Nebula Enviro</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="{{ url('/admin/uploads') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">Upload Image</div>
            </a>
        </li>
        <!-- Forms & Tables -->
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">Testimoni</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('/admin/testimonials') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">Daftar Testimoni</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/admin/testimonial/create') }}" class="menu-link">
                        <div data-i18n="Input groups">Tambah Testimoni</div>
                    </a>
                </li>
            </ul>
        </li>
